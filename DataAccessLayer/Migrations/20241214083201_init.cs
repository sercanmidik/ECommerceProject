        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ServiceId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NameTwo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImageName = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SliderTitleTwo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    LongDescriptionTwo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LongDescriptionThree = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "LatestDiscounts",
                columns: table => new
                {
                    LatestDiscountId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LatestDiscounts", x => x.LatestDiscountId);
                    table.ForeignKey(
                        name: "FK_LatestDiscounts_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MainSliders_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LatestDiscounts_ProductId",
                table: "LatestDiscounts",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_MainSliders_ProductId",
                table: "MainSliders",
                column: "ProductId");
